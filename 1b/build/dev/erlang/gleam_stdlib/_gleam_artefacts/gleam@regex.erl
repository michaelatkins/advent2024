...
-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/regex.gleam", 62).
-spec compile(binary(), options()) -> {ok, regex()} | {error, compile_error()}.
compile(Pattern, Options) ->
    gleam_stdlib:compile_regex(Pattern, Options).

-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/regex.gleam", 91).
-spec from_string(binary()) -> {ok, regex()} | {error, compile_error()}.
from_string(Pattern) ->
    gleam_stdlib:compile_regex(Pattern, {options, false, false}).

-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/regex.gleam", 113).
-spec check(regex(), binary()) -> boolean().
check(Regex, String) ->
    gleam_stdlib:regex_check(Regex, String).

-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/regex.gleam", 128).
-spec split(regex(), binary()) -> list(binary()).
split(Regex, String) ->
    gleam_stdlib:regex_split(Regex, String).

-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/regex.gleam", 185).
-spec scan(regex(), binary()) -> list(match()).
scan(Regex, String) ->
    gleam_stdlib:regex_scan(Regex, String).

-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/regex.gleam", 206).
