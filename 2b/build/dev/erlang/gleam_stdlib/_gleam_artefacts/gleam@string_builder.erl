...
-file("/Users/maatkn/Documents/Code/aoc/2024/2b/build/packages/gleam_stdlib/src/gleam/string_builder.gleam", 27).
-spec new() -> gleam@string_tree:string_tree().
new() ->
    gleam_stdlib:identity([]).

-file("/Users/maatkn/Documents/Code/aoc/2024/2b/build/packages/gleam_stdlib/src/gleam/string_builder.gleam", 36).
...
-file("/Users/maatkn/Documents/Code/aoc/2024/2b/build/packages/gleam_stdlib/src/gleam/string_builder.gleam", 45).
...
-file("/Users/maatkn/Documents/Code/aoc/2024/2b/build/packages/gleam_stdlib/src/gleam/string_builder.gleam", 54).
...
-file("/Users/maatkn/Documents/Code/aoc/2024/2b/build/packages/gleam_stdlib/src/gleam/string_builder.gleam", 66).
-spec append_builder(
    gleam@string_tree:string_tree(),
    gleam@string_tree:string_tree()
) -> gleam@string_tree:string_tree().
...
-file("/Users/maatkn/Documents/Code/aoc/2024/2b/build/packages/gleam_stdlib/src/gleam/string_builder.gleam", 78).
-spec from_strings(list(binary())) -> gleam@string_tree:string_tree().
from_strings(Strings) ->
    gleam_stdlib:identity(Strings).

-file("/Users/maatkn/Documents/Code/aoc/2024/2b/build/packages/gleam_stdlib/src/gleam/string_builder.gleam", 87).
-spec concat(list(gleam@string_tree:string_tree())) -> gleam@string_tree:string_tree().
concat(Builders) ->
    gleam_stdlib:identity(Builders).

-file("/Users/maatkn/Documents/Code/aoc/2024/2b/build/packages/gleam_stdlib/src/gleam/string_builder.gleam", 96).
-spec from_string(binary()) -> gleam@string_tree:string_tree().
from_string(String) ->
    gleam_stdlib:identity(String).

-file("/Users/maatkn/Documents/Code/aoc/2024/2b/build/packages/gleam_stdlib/src/gleam/string_builder.gleam", 106).
-spec to_string(gleam@string_tree:string_tree()) -> binary().
to_string(Builder) ->
    unicode:characters_to_binary(Builder).

-file("/Users/maatkn/Documents/Code/aoc/2024/2b/build/packages/gleam_stdlib/src/gleam/string_builder.gleam", 113).
-spec byte_size(gleam@string_tree:string_tree()) -> integer().
byte_size(Builder) ->
    erlang:iolist_size(Builder).

-file("/Users/maatkn/Documents/Code/aoc/2024/2b/build/packages/gleam_stdlib/src/gleam/string_builder.gleam", 120).
-spec join(list(gleam@string_tree:string_tree()), binary()) -> gleam@string_tree:string_tree().
join(Builders, Sep) ->
    gleam@string_tree:join(Builders, Sep).

-file("/Users/maatkn/Documents/Code/aoc/2024/2b/build/packages/gleam_stdlib/src/gleam/string_builder.gleam", 128).
-spec lowercase(gleam@string_tree:string_tree()) -> gleam@string_tree:string_tree().
lowercase(Builder) ->
    string:lowercase(Builder).

-file("/Users/maatkn/Documents/Code/aoc/2024/2b/build/packages/gleam_stdlib/src/gleam/string_builder.gleam", 136).
-spec uppercase(gleam@string_tree:string_tree()) -> gleam@string_tree:string_tree().
uppercase(Builder) ->
    string:uppercase(Builder).

-file("/Users/maatkn/Documents/Code/aoc/2024/2b/build/packages/gleam_stdlib/src/gleam/string_builder.gleam", 143).
-spec reverse(gleam@string_tree:string_tree()) -> gleam@string_tree:string_tree().
reverse(Builder) ->
    string:reverse(Builder).

-file("/Users/maatkn/Documents/Code/aoc/2024/2b/build/packages/gleam_stdlib/src/gleam/string_builder.gleam", 150).
...
-file("/Users/maatkn/Documents/Code/aoc/2024/2b/build/packages/gleam_stdlib/src/gleam/string_builder.gleam", 159).
...
-file("/Users/maatkn/Documents/Code/aoc/2024/2b/build/packages/gleam_stdlib/src/gleam/string_builder.gleam", 185).
-spec is_equal(gleam@string_tree:string_tree(), gleam@string_tree:string_tree()) -> boolean().
is_equal(A, B) ->
    string:equal(A, B).

-file("/Users/maatkn/Documents/Code/aoc/2024/2b/build/packages/gleam_stdlib/src/gleam/string_builder.gleam", 210).
