...
-file("/Users/maatkn/Documents/Code/aoc/2024/2b/build/packages/gleam_stdlib/src/gleam/bytes_builder.gleam", 34).
-spec new() -> gleam@bytes_tree:bytes_tree().
new() ->
    gleam_stdlib:identity([]).

-file("/Users/maatkn/Documents/Code/aoc/2024/2b/build/packages/gleam_stdlib/src/gleam/bytes_builder.gleam", 43).
...
-file("/Users/maatkn/Documents/Code/aoc/2024/2b/build/packages/gleam_stdlib/src/gleam/bytes_builder.gleam", 52).
...
-file("/Users/maatkn/Documents/Code/aoc/2024/2b/build/packages/gleam_stdlib/src/gleam/bytes_builder.gleam", 61).
...
-file("/Users/maatkn/Documents/Code/aoc/2024/2b/build/packages/gleam_stdlib/src/gleam/bytes_builder.gleam", 74).
-spec append_builder(
    gleam@bytes_tree:bytes_tree(),
    gleam@bytes_tree:bytes_tree()
) -> gleam@bytes_tree:bytes_tree().
...
-file("/Users/maatkn/Documents/Code/aoc/2024/2b/build/packages/gleam_stdlib/src/gleam/bytes_builder.gleam", 87).
...
-file("/Users/maatkn/Documents/Code/aoc/2024/2b/build/packages/gleam_stdlib/src/gleam/bytes_builder.gleam", 97).
...
-file("/Users/maatkn/Documents/Code/aoc/2024/2b/build/packages/gleam_stdlib/src/gleam/bytes_builder.gleam", 107).
-spec concat(list(gleam@bytes_tree:bytes_tree())) -> gleam@bytes_tree:bytes_tree().
concat(Builders) ->
    gleam_stdlib:identity(Builders).

-file("/Users/maatkn/Documents/Code/aoc/2024/2b/build/packages/gleam_stdlib/src/gleam/bytes_builder.gleam", 117).
-spec concat_bit_arrays(list(bitstring())) -> gleam@bytes_tree:bytes_tree().
concat_bit_arrays(Bits) ->
    gleam_stdlib:identity(Bits).

-file("/Users/maatkn/Documents/Code/aoc/2024/2b/build/packages/gleam_stdlib/src/gleam/bytes_builder.gleam", 128).
-spec from_string(binary()) -> gleam@bytes_tree:bytes_tree().
from_string(String) ->
    gleam_stdlib:wrap_list(String).

-file("/Users/maatkn/Documents/Code/aoc/2024/2b/build/packages/gleam_stdlib/src/gleam/bytes_builder.gleam", 139).
...
-file("/Users/maatkn/Documents/Code/aoc/2024/2b/build/packages/gleam_stdlib/src/gleam/bytes_builder.gleam", 149).
-spec from_bit_array(bitstring()) -> gleam@bytes_tree:bytes_tree().
from_bit_array(Bits) ->
    gleam_stdlib:wrap_list(Bits).

-file("/Users/maatkn/Documents/Code/aoc/2024/2b/build/packages/gleam_stdlib/src/gleam/bytes_builder.gleam", 162).
-spec to_bit_array(gleam@bytes_tree:bytes_tree()) -> bitstring().
to_bit_array(Builder) ->
    erlang:list_to_bitstring(Builder).

-file("/Users/maatkn/Documents/Code/aoc/2024/2b/build/packages/gleam_stdlib/src/gleam/bytes_builder.gleam", 172).
