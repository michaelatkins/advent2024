...
-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/dict.gleam", 36).
-spec size(dict(any(), any())) -> integer().
size(Dict) ->
    maps:size(Dict).

-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/dict.gleam", 80).
-spec to_list(dict(KR, KS)) -> list({KR, KS}).
to_list(Dict) ->
    maps:to_list(Dict).

-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/dict.gleam", 129).
-spec new() -> dict(any(), any()).
new() ->
    maps:new().

-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/dict.gleam", 52).
-spec is_empty(dict(any(), any())) -> boolean().
is_empty(Dict) ->
    Dict =:= maps:new().

-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/dict.gleam", 150).
-spec get(dict(LU, LV), LU) -> {ok, LV} | {error, nil}.
get(From, Get) ->
    gleam_stdlib:map_get(From, Get).

-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/dict.gleam", 116).
-spec has_key(dict(LI, any()), LI) -> boolean().
has_key(Dict, Key) ->
    maps:is_key(Key, Dict).

-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/dict.gleam", 169).
-spec insert(dict(MA, MB), MA, MB) -> dict(MA, MB).
insert(Dict, Key, Value) ->
    maps:put(Key, Value, Dict).

-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/dict.gleam", 92).
...
-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/dict.gleam", 88).
-spec from_list(list({KW, KX})) -> dict(KW, KX).
from_list(List) ->
    maps:from_list(List).

-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/dict.gleam", 217).
...
-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/dict.gleam", 224).
...
-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/dict.gleam", 212).
-spec keys(dict(NA, any())) -> list(NA).
keys(Dict) ->
    maps:keys(Dict).

-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/dict.gleam", 250).
...
-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/dict.gleam", 245).
-spec values(dict(any(), NP)) -> list(NP).
values(Dict) ->
    maps:values(Dict).

-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/dict.gleam", 319).
...
-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/dict.gleam", 310).
-spec take(dict(OK, OL), list(OK)) -> dict(OK, OL).
take(Dict, Desired_keys) ->
    maps:with(Desired_keys, Dict).

-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/dict.gleam", 357).
-spec insert_pair(dict(PP, PQ), {PP, PQ}) -> dict(PP, PQ).
insert_pair(Dict, Pair) ->
    insert(Dict, erlang:element(1, Pair), erlang:element(2, Pair)).

-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/dict.gleam", 361).
...
-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/dict.gleam", 351).
-spec merge(dict(PH, PI), dict(PH, PI)) -> dict(PH, PI).
merge(Dict, New_entries) ->
    maps:merge(Dict, New_entries).

-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/dict.gleam", 383).
-spec delete(dict(QC, QD), QC) -> dict(QC, QD).
delete(Dict, Key) ->
    maps:remove(Key, Dict).

-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/dict.gleam", 411).
...
-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/dict.gleam", 441).
...
-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/dict.gleam", 486).
...
-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/dict.gleam", 478).
-spec fold(dict(RC, RD), RG, fun((RG, RC, RD) -> RG)) -> RG.
fold(Dict, Initial, Fun) ->
    fold_loop(maps:to_list(Dict), Initial, Fun).

-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/dict.gleam", 188).
-spec map_values(dict(MM, MN), fun((MM, MN) -> MQ)) -> dict(MM, MQ).
map_values(Dict, Fun) ->
    maps:map(Fun, Dict).

-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/dict.gleam", 274).
-spec filter(dict(NY, NZ), fun((NY, NZ) -> boolean())) -> dict(NY, NZ).
filter(Dict, Predicate) ->
    maps:filter(Predicate, Dict).

-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/dict.gleam", 519).
...
-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/dict.gleam", 540).
