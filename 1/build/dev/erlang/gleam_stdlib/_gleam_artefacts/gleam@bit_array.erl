...
-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 11).
-spec from_string(binary()) -> bitstring().
from_string(X) ->
    gleam_stdlib:identity(X).

-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 24).
-spec byte_size(bitstring()) -> integer().
byte_size(X) ->
    erlang:byte_size(X).

-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 16).
-spec bit_size(bitstring()) -> integer().
bit_size(X) ->
    erlang:bit_size(X).

-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 29).
-spec pad_to_bytes(bitstring()) -> bitstring().
pad_to_bytes(X) ->
    gleam_stdlib:bit_array_pad_to_bytes(X).

-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 56).
...
-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 69).
...
-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 64).
-spec is_utf8(bitstring()) -> boolean().
is_utf8(Bits) ->
    is_utf8_loop(Bits).

-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 90).
...
-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 111).
-spec concat(list(bitstring())) -> bitstring().
concat(Bit_arrays) ->
    gleam_stdlib:bit_array_concat(Bit_arrays).

-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 42).
-spec append(bitstring(), bitstring()) -> bitstring().
append(First, Second) ->
    gleam_stdlib:bit_array_concat([First, Second]).

-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 120).
-spec base64_encode(bitstring(), boolean()) -> binary().
base64_encode(Input, Padding) ->
    gleam_stdlib:bit_array_base64_encode(Input, Padding).

-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 124).
...
-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 142).
...
-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 151).
...
-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 165).
-spec base16_encode(bitstring()) -> binary().
base16_encode(Input) ->
    gleam_stdlib:base16_encode(Input).

-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 171).
-spec base16_decode(binary()) -> {ok, bitstring()} | {error, nil}.
base16_decode(Input) ->
    gleam_stdlib:base16_decode(Input).

-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 190).
...
-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 185).
-spec inspect(bitstring()) -> binary().
inspect(Input) ->
    <<(inspect_loop(Input, <<"<<"/utf8>>))/binary, ">>"/utf8>>.

-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 232).
...
-file("/Users/maatkn/Documents/Code/aoc/2024/1/build/packages/gleam_stdlib/src/gleam/bit_array.gleam", 272).
